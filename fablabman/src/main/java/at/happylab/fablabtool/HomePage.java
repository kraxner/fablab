...
public class HomePage extends WebPage {
	...
	public HomePage() {
	    ...
	    final Component inputRfId = new TextField<Serializable>("inputRfid", new Model<Serializable>()
				{
		         private static final long serialVersionUID = 1L;
	    ...
	    Component checkLink = new ExternalLink("checkAccess", "services/keycard//access", "Check Access");
	    ...
	    final Component updateButton = new AjaxButton("updateLink") {
			...
			protected void onSubmit(AjaxRequestTarget arg0, Form<?> arg1) {
				...
				Component newLink = new ExternalLink("checkAccess", url, "Check Access for " + rfid).setOutputMarkupId(true);
